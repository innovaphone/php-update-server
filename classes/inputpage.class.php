...
class InputPageCountryDropdownField extends InputPageDropdownField {
    public function __construct($name, $prompt, $default = null) {
        $options = array("" => "",
                ...
                "Bhutan" => tl::tl("Bhutan"),
                "Bolivia, Plurinational State of" => tl::tl("Bolivia, Plurinational State of"),
                ...
                "Brunei Darussalam" => tl::tl("Brunei Darussalam"),
                ...
                "Congo, the Democratic Republic of the" => tl::tl("Congo, the Democratic Republic of the"),
                "Congo, the Republic of" => tl::tl("Congo, the Republic of"),
                ...
                "Cuba" => tl::tl("Cuba"),
                "Cyprus" => tl::tl("Cyprus"),
                "Czech Republic" => tl::tl("Czech Republic"),
                ...
                "Holy See (Vatican City State)" => tl::tl("Holy See (Vatican City State)"),
                ...
                "Korea, Republic of" => tl::tl("Korea, Republic of"),
                "Kosovo" => tl::tl("Kosovo"),
                "Kuwait" => tl::tl("Kuwait"),
                "Kyrgyzstan" => tl::tl("Kyrgyzstan"),
                "Lao People's Democratic Republic" => tl::tl("Lao People's Democratic Republic"),
                "Latvia" => tl::tl("Latvia"),
                "Lebanon" => tl::tl("Lebanon"),
                "Lesotho" => tl::tl("Lesotho"),
                "Liberia" => tl::tl("Liberia"),
                "Libyan Arab Jamahiriya" => tl::tl("Libyan Arab Jamahiriya"),
                "Liechtenstein" => tl::tl("Liechtenstein"),
                "Lithuania" => tl::tl("Lithuania"),
                "Luxembourg" => tl::tl("Luxembourg"),
                "Macao" => tl::tl("Macao"),
                "Macedonia, the former Yugoslav Republic of" => tl::tl("Macedonia, the former Yugoslav Republic of"),
                ...
                "Russian Federation" => tl::tl("Russian Federation"),
                "Rwanda" => tl::tl("Rwanda"),
